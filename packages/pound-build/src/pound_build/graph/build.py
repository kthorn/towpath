...
from pound.models import WaterwayKind, WayDimensions

from pound_build.ingest.filters import extract_access_caveats, extract_dimensions
...
def build_graph(features: WaterwayFeatures) -> nx.Graph:
    ...
    for node in features.nodes:
        ...
        for u, v, edge_data in g.edges(data=True):
            ...
            key = (float(projection[1]), float(edge_data["length_m"]), low, high)
