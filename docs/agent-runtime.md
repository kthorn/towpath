...
See the [package README](../packages/towpath-agent/README.md) for setup and smoke tests.
...
host admission/rate limits separately. The live smoke result is a connectivity check, not a cost or latency benchmark.
